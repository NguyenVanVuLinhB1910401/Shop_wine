          ...
          >
            ...
            <div class="row mx-auto">
              ...
              <div class="col-sm-6">
                <div class="mt-4 mb-3">
                  <div class="col-sm-11 mx-auto">
                    <label class="form-label col-sm-5">Số điện thoại</label>
                    <Field
                      class="form-control"
                      name="phone"
                      type="text"
...
export default {
  ...
  methods: {
    async handleAddNhanVien() {
      if (this.nhanvien.matkhau === this.nhaplaimatkhau) {
        const respone = await nhanvienService.addNhanVien(this.nhanvien);
        //console.log(respone);
